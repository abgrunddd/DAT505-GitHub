...
```
##### This code defines that  the initial position and the initial size of the geometry.
...
```
##### And what this code means is it defines the acceleration along the x and y axes of these geometries.
